...
import { Building2, Activity, MessageSquare } from 'lucide-react';
...
const Hospital = () => {
  ...
  const features = [
    { icon: Building2, title: t.feature1, desc: t.feature1Desc },
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              <img
                src="https://images.unsplash.com/photo-1770134195107-0217c17ccaad?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA1MTN8MHwxfHNlYXJjaHwzfHxob3NwaXRhbCUyMHRlY2hub2xvZ3l8ZW58MHx8fHwxNzczODkyNzE4fDA&ixlib=rb-4.1.0&q=85"
